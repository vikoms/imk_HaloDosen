    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-medium text-2xl">HaloDosen</h1>
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">Sistem Informasi Pengajuan Dosen Pembimbing
                    Skripsi.<br>Ajukan dan pantau bimbinganmu dengan mudah.</p>
            ...
            <div
                ...
                <img src="/images/logo.png" alt="HaloDosen Logo" class="max-w-[80%] max-h-[80%] object-contain" />
